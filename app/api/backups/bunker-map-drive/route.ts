...
const TABLES: TableConfig[] = [
  ...
  { key: "eventCalendarGoogleSyncJobs", table: "event_calendar_google_sync_jobs", order: [{ column: "event_id", ascending: true }] },
  ...
  { key: "attendanceReminderDispatches", table: "attendance_reminder_dispatches", order: [{ column: "id", ascending: true }] },
