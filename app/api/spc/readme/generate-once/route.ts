...
const TOKEN_DIGEST = "a8c25a543f2dc7494f84f63ac458bee0efc9119b33937190bdccc3b055881861"
const EXPIRES_AT = Date.parse("2026-07-23T23:00:00+08:00")
    ...
    const response = await fetch("https://api.openai.com/v1/audio/speech", {
      ...
      body: JSON.stringify({
        ...
        instructions: [
          ...
          "Pronounce enquiry as en-KWY-ree and enquiries as en-KWY-reez, with three clean syllables.",
