    ...
    if (payload.action === "response") {
      ...
      const response = await fetch("https://api.openai.com/v1/responses", {
        ...
        body: JSON.stringify({
          ...
          store: false,
          instructions: [
            "Respond as a precise drafting assistant for an educational bunker-trading demonstration.",
            "Follow the requested output format exactly.",
            "Never invent missing commercial information.",
            "Preserve quantities, ranges, decimal points, dates, grades, and specifications exactly.",
