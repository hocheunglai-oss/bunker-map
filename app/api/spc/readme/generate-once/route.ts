    ...
    const response = await fetch("https://api.openai.com/v1/audio/speech", {
      ...
      body: JSON.stringify({
        ...
        instructions: [
          ...
          "Use a calm, clear corporate presentation tone for an international audience.",
          "Articulate every commercial term distinctly at a listener-friendly pace.",
          "Use short, natural sentence pauses and no long or dramatic pauses between numbered points.",
          "Read connected points as one continuous explanation.",
