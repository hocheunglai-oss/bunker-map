...
const TOKEN_DIGEST = "04111b27cef210779f1aee39043cef4114f624d43b6c00283ed35f173d7d479b"
const EXPIRES_AT = Date.parse("2026-08-13T12:30:00Z")
...
type Payload = {
  action?: "load" | "prepare-upload" | "complete-upload"
  id?: string
  revision?: number
  fileName?: string
  fileBytes?: number
