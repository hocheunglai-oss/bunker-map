...
const SERVICES = [
  ...
  ["ATTENDANCE RECORDS", "DINGTALK RAW PUNCH DETAILS / SHORT-LIVED APP TOKEN / 7-DAY QUERY WINDOW / ADMIN-ONLY / NO-STORE", "DINGTALK / MOREDIAN MCE-M2+", "/API/ADMIN/DINGTALK-ATTENDANCE"],
