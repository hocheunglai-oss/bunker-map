...
const SERVICES = [
  ...
  ["DATABASE ARTIFACT BACKUP", "MUTATION-FENCED PAGED JSON V2 / BOUNDED STREAMING / SHA-256 PREDECESSOR CHAIN", "VERCEL / GOOGLE DRIVE", "BUNKER MAP BACKUPS / DAILY SUPABASE BACKUPS"],
  ...
  ["ADMIN SESSION SECURITY", "RANDOM SERVER SESSION / SHA-256 TOKEN / RENEWABLE 400-DAY BROWSER-MAXIMUM PERSISTENCE / REVOCATION / FORCED PASSWORD ROTATION", "SUPABASE / HTTPONLY COOKIE", "ACTIVE USE RENEWS HOURLY UNTIL LOGOUT; DORMANT SESSIONS EXPIRE; PASSWORD CHANGE, ACCOUNT DISABLEMENT, OR REVOCATION FAILS CLOSED; ADMIN_SESSIONS IS EPHEMERAL AND NEVER BACKED UP"],
  ...
  ["EXCHANGE WORKER", "POWERSHELL RUNBOOK / CHANGE-ONLY INCREMENTAL NOTICES / 180-MIN FULL LEASE / STAGED SNAPSHOT CERTIFICATION / SPLIT TEMPLATE RECONCILIATION", "AZURE AUTOMATION", "FCUNO-EXCHANGE-RUNBOOK/2026-07-24.4"],
  ["OUTLOOK TEMPLATE SOURCE", "EMAIL_TEMPLATES ONLY / TRANSACTIONAL RPC / OPTIMISTIC REVISION", "SUPABASE", "AUDITED CANONICAL LIBRARY; LEGACY STORE ARCHIVED"],
  ["OUTLOOK ADD-IN ACCESS", "OFFICE DIALOG API / HTTP-ONLY PARTITIONED 400-DAY SESSION / AUTOMATIC LEGACY-SESSION MIGRATION / NON-CACHEABLE TASKPANE AND AUTH SHELL / MANUAL SIGN-OUT / NESTED APP AUTHENTICATION / GRAPH-CREATED MESSAGE WITH MEASURED 6-SECOND INDEX-READY DIRECT COMPOSE POP-OUT ON CURRENT OUTLOOK CLOUD HOST / PARALLEL TEMPLATE + CERTIFIED DIRECTORY PRELOAD / TWO-PHASE APPEND-ONLY INSERT AUDIT", "NEXT.JS / OFFICE.JS / MSAL.JS / MICROSOFT GRAPH", "TEMPLATE ACTION OPENS A SEPARATE EDITABLE PRE-FILLED OUTLOOK MESSAGE WITHOUT NAVIGATING THE CURRENT WINDOW TO DRAFTS; DELEGATED MAIL.READWRITE ONLY; NO TOKEN IN MAILBOX ROAMING SETTINGS; NO ANONYMOUS TEMPLATE OR DIRECTORY ACCESS; PASSWORD CHANGE, ACCOUNT DISABLEMENT, REVOCATION, OR PERMISSION REMOVAL FAILS CLOSED"],
...
const SCHEDULES = [
  ...
  ["EXCHANGE INCREMENTAL DELIVERY", "HOURLY AT :31 HKT + FCUNO WEBHOOK", "AZURE AUTOMATION", "SILENT WHEN UNCHANGED / NOTICE ON USER CHANGE OR FAILURE"],
  ["EXCHANGE FULL RECONCILIATION", "DAILY 04:10 HKT + ON DEMAND", "AZURE AUTOMATION", "EXACT CERTIFICATION / START FULL IN AZURE"],
      ...
      <main className={styles.shell}>
        ...
        <section className={styles.section}>
          ...
          <div className={styles.notes}>
            ...
            <p>EXCHANGE LIVE-VERIFIED 2026-07-23: ACCOUNT FCUNO-EXCHANGE-SYNC; RUNBOOK SYNC-FCUNO-OUTLOOKADDRESSBOOK; HOURLY INCREMENTAL AND DAILY 04:10 HKT FULL SCHEDULES ENABLED; WEBHOOK FC UNO EXCHANGE SYNC ENABLED THROUGH 2035-05-29.</p>
