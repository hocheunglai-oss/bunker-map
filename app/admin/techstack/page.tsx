...
const SERVICES = [
  ...
  ["OUTLOOK ADD-IN ACCESS", "OFFICE DIALOG API / RENEWABLE 400-DAY PERSISTENT SERVER SESSION / MANUAL SIGN-OUT / OFFICE-SAFE IN-PANE REPLACEMENT CONFIRMATION / LAZY CERTIFIED DIRECTORY / PINNED ITEM-CHANGE GUARD / TWO-PHASE APPEND-ONLY INSERT AUDIT", "NEXT.JS / OFFICE.JS", "NO ANONYMOUS TEMPLATE OR DIRECTORY ACCESS; PASSWORD CHANGE, ACCOUNT DISABLEMENT, REVOCATION, OR PERMISSION REMOVAL FAILS CLOSED; MAILBOX 1.4+, PINNING GUARD 1.5+"],
