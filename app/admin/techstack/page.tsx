      ...
      <main className={styles.shell}>
        ...
        <section className={styles.section}>
          ...
          <div className={styles.notes}>
            ...
            <p>GOOGLE CLOUD COST CONTROL — VERIFIED 2026-09-24: PROJECT MONTHLY ALERT BUDGET HKD77.50 (CONSERVATIVE APPROXIMATION OF USD10). AN ALERTS-ONLY BUDGET DOES NOT STOP SPENDING. THE SEPARATE CLOUD RUN CAP IS NOT YET ACTIVATED; A CLOUD RUN SPEND CAP DOES NOT CAP STORAGE CHARGES OR GUARANTEE AN EXACT TOTAL BILL.</p>
