...
const SERVICES = [
  ...
  ["ADMIN SESSION SECURITY", "RANDOM SERVER SESSION / SHA-256 TOKEN / EXPIRY / REVOCATION / FORCED PASSWORD ROTATION", "SUPABASE / HTTPONLY COOKIE", "ADMIN_SESSIONS IS EPHEMERAL AND NEVER BACKED UP"],
  ...
  ["OUTLOOK ADD-IN ACCESS", "OFFICE DIALOG API / 30-MINUTE SERVER SESSION / PINNED ITEM-CHANGE GUARD / TWO-PHASE APPEND-ONLY INSERT AUDIT", "NEXT.JS / OFFICE.JS", "NO ANONYMOUS TEMPLATE OR DIRECTORY ACCESS; MAILBOX 1.4+, PINNING GUARD 1.5+"],
  ["OUTLOOK RECIPIENT TRUTH", "STABLE FCUNO IDS / CERTIFIED EXACT EXCHANGE ADDRESSES / DEEP DATABASE GUARD", "SUPABASE / EXCHANGE ONLINE", "EVERY CERTIFICATION RECONCILES; STALE, UNRESOLVED, OR UNVERIFIED GROUP SMTP RECIPIENTS FAIL CLOSED"],
