...
const SERVICES = [
  ...
  ["OUTLOOK ADD-IN ACCESS", "OFFICE DIALOG API / RENEWABLE 400-DAY PERSISTENT SERVER SESSION / MANUAL SIGN-OUT / NESTED APP AUTHENTICATION / GRAPH-CREATED NEW DRAFT / LAZY CERTIFIED DIRECTORY / TWO-PHASE APPEND-ONLY INSERT AUDIT", "NEXT.JS / OFFICE.JS / MSAL.JS / MICROSOFT GRAPH", "TEMPLATE ACTION ALWAYS OPENS A SEPARATE PRE-FILLED MESSAGE AND NEVER REPLACES THE CURRENT DRAFT; DELEGATED MAIL.READWRITE ONLY; NO ANONYMOUS TEMPLATE OR DIRECTORY ACCESS; PASSWORD CHANGE, ACCOUNT DISABLEMENT, REVOCATION, OR PERMISSION REMOVAL FAILS CLOSED"],
