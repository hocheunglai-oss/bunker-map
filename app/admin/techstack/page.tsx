...
const SERVICES = [
  ...
  ["EXCHANGE WORKER", "POWERSHELL RUNBOOK / CHECKPOINTED NOTICES / 180-MIN FULL LEASE / SPLIT TEMPLATE RECONCILIATION", "AZURE AUTOMATION", "FCUNO-EXCHANGE-RUNBOOK/2026-07-24.2"],
