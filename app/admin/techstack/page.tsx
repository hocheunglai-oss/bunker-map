...
const SERVICES = [
  ...
  ["OUTLOOK ADD-IN ACCESS", "OFFICE DIALOG API / HTTP-ONLY PARTITIONED 400-DAY SESSION / MANUAL SIGN-OUT / NESTED APP AUTHENTICATION / GRAPH-CREATED MESSAGE OPENED BY TRUSTED OUTLOOK POP-OUT LINK / PARALLEL TEMPLATE + CERTIFIED DIRECTORY PRELOAD / TWO-PHASE APPEND-ONLY INSERT AUDIT", "NEXT.JS / OFFICE.JS / MSAL.JS / MICROSOFT GRAPH", "TEMPLATE ACTION OPENS A SEPARATE PRE-FILLED OUTLOOK MESSAGE WITHOUT NAVIGATING THE CURRENT WINDOW TO DRAFTS; DELEGATED MAIL.READWRITE ONLY; NO TOKEN IN MAILBOX ROAMING SETTINGS; NO ANONYMOUS TEMPLATE OR DIRECTORY ACCESS; PASSWORD CHANGE, ACCOUNT DISABLEMENT, REVOCATION, OR PERMISSION REMOVAL FAILS CLOSED"],
