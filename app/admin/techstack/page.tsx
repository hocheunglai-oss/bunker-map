...
const SERVICES = [
  ...
  ["OUTLOOK ADD-IN ACCESS", "OFFICE DIALOG API / HTTP-ONLY PARTITIONED 400-DAY SESSION / AUTOMATIC LEGACY-SESSION MIGRATION / NON-CACHEABLE TASKPANE AND AUTH SHELL / MANUAL SIGN-OUT / DIRECT OUTLOOK NEW-MESSAGE COMPOSE DEEP LINK / COALESCED TEMPLATE DETAIL + CERTIFIED DIRECTORY PRELOAD / TWO-PHASE APPEND-ONLY INSERT AUDIT", "NEXT.JS / OFFICE.JS / OUTLOOK WEB", "TEMPLATE ACTION OPENS A SEPARATE EDITABLE PLAIN-TEXT PRE-FILLED OUTLOOK MESSAGE WITHOUT GRAPH DRAFT CREATION, A MICROSOFT TOKEN PROMPT, OR NAVIGATING THE CURRENT WINDOW TO DRAFTS; NO TOKEN IN MAILBOX ROAMING SETTINGS; NO ANONYMOUS TEMPLATE OR DIRECTORY ACCESS; PASSWORD CHANGE, ACCOUNT DISABLEMENT, REVOCATION, OR PERMISSION REMOVAL FAILS CLOSED"],
