...
const SCHEDULES = [
  ...
  ["EXCHANGE INCREMENTAL DELIVERY", "FCUNO WEBHOOK / DURABLE QUEUE", "AZURE AUTOMATION", "RETRY + VERIFIED CHECKPOINT NOTICE"],
  ["EXCHANGE FULL RECONCILIATION", "DAILY AND ON DEMAND", "AZURE AUTOMATION", "EXACT PROJECTION CERTIFICATION"],
