...
const SERVICES = [
  ...
  ["ADMIN SESSION SECURITY", "RANDOM SERVER SESSION / SHA-256 TOKEN / 400-DAY BROWSER-MAXIMUM PERSISTENCE / REVOCATION / FORCED PASSWORD ROTATION", "SUPABASE / HTTPONLY COOKIE", "PERSISTS UNTIL LOGOUT IN NORMAL USE; HOURLY LAST-SEEN WRITE; PASSWORD CHANGE, ACCOUNT DISABLEMENT, OR REVOCATION FAILS CLOSED; ADMIN_SESSIONS IS EPHEMERAL AND NEVER BACKED UP"],
