...
const SERVICES = [
  ["APPLICATION", "NEXT.JS 14 / REACT 18 / TYPESCRIPT", "VERCEL", "FCUNO.COM"],
  ...
  ["BACKUP SCHEDULER", "CLOUD SCHEDULER", "GOOGLE CLOUD", "WEEKLY"],
  ["CONTACT SYNC", "GOOGLE PEOPLE API", "GOOGLE", "COSULICH.UNO@GMAIL.COM"],
  ["CALENDAR SYNC", "GOOGLE CALENDAR API", "GOOGLE", "FCB.BUNKER@GMAIL.COM"],
  ["ADDRESS BOOK", "CARDDAV", "EXTERNAL SERVICE", "CONFIGURED IN VERCEL"],
...
const SCHEDULES = [
  ...
  ["CCINFO FILE BACKUP", "SATURDAY 20:00 UTC", "GOOGLE CLOUD SCHEDULER", "GCS / VERSIONED"],
      ...
      <main className={styles.shell}>
        ...
        <section className={styles.section}>
          ...
          <div className={styles.notes}>
            <p>CCINFO FILES: 7,011 OBJECTS / 6,926 ACTIVE DATABASE REFERENCES COVERED.</p>
