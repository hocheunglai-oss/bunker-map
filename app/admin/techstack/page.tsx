...
const SERVICES = [
  ...
  ["DATABASE ARTIFACT BACKUP", "MUTATION-FENCED PAGED JSON V2 / GZIP-BOUNDED TEMP STAGING / STREAMED JSON UPLOAD / SHA-256 PREDECESSOR CHAIN", "VERCEL / GOOGLE DRIVE", "BUNKER MAP BACKUPS / DAILY SUPABASE BACKUPS"],
  ...
  ["EXCHANGE WORKER", "POWERSHELL RUNBOOK / CHANGE-OR-ERROR-ONLY NOTICES FOR INCREMENTAL + FULL RUNS / 3-ATTEMPT TEMPORARY EXCHANGE RETRY / 180-MIN FULL LEASE / STAGED SNAPSHOT CERTIFICATION / SPLIT TEMPLATE RECONCILIATION", "AZURE AUTOMATION", "FCUNO-EXCHANGE-RUNBOOK/2026-08-03.1"],
...
const SCHEDULES = [
  ["SUPABASE DATA BACKUP", "DAILY 19:02 UTC", "VERCEL CRON", "GOOGLE DRIVE / VERIFIED V2 / 35-DAY WINDOW"],
  ["ATTENDANCE RECONCILIATION", "EVERY 15 MINUTES / ROLLING 7 DAYS", "VERCEL CRON", "DINGTALK RAW PUNCHES / IDEMPOTENT UPSERT"],
