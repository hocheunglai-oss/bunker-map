              ...
              <tbody>
                {filteredPorts.map((row) => (
                  <tr key={row.id}>
                    ...
                    <td style={{ ...tdStyle, whiteSpace: "nowrap", color: "var(--fc-admin-link)" }}>{row.country_name || ""}</td>
                    ...
                    <td style={{ ...tdStyle, whiteSpace: "nowrap" }}>
                      <button onClick={() => void deletePort(row)} style={{ ...buttonStyle, padding: "6px 10px", fontSize: "11px", background: "var(--fc-admin-danger-bg)", color: "var(--fc-admin-danger-text)", border: "1px solid var(--fc-admin-danger-border)" }}>Delete</button>
                    </td>
                  </tr>
                ))}
              </tbody>
