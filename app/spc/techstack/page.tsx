...
const SERVICES = [
  ...
  ["AUTHENTICATION", "ACTIVE FCUNO SESSION AUTO-RESUME / USERNAME-FIRST FCUNO OR EXTERNAL ROUTING / FCUNO-LINKED STAFF HANDOFF / EXTERNAL SPC CREDENTIALS / FORCED FIRST-LOGIN CHANGE / AUDITED SPC PASSWORD CHANGES / OPAQUE 400-DAY SLIDING SERVER SESSIONS / DAILY ACTIVITY RENEWAL / SHA-256 TOKEN HASH / LOGOUT + REVOCATION + ACCOUNT-CHANGE INVALIDATION", "SPC APP / FCUNO / SUPABASE", "SPC USERS"],
  ...
  ["ENQUIRY OUTCOME TRACKING", "USER-SCOPED SENT ENQUIRIES ACROSS COMPUTERS / OWNER-ONLY OUTCOME, AMENDMENT + REOFFER / IMMUTABLE REVISION HISTORY / SHARED SUPPLIER-TRADER SPEED BOARD FEED / FIXTURES / BUYER + SUPPLIER LOST REVIEW / SPC COMMENTS", "SPC APP", "SPC_ENQUIRIES / SPC_ENQUIRY_REVISIONS / SPC_FIXTURES / SPC_LOST_REASON_OPTIONS"],
  ["SUPPLIER DAILY ENQUIRIES", "HONG KONG DAY VIEW / CHRONOLOGICAL BUYER FEED / PREVIOUS FIXTURE + LOST MATCHES / MULTI-SELECT BULK COPY", "SPC APP / SUPABASE", "/SPC/TODAY-ENQUIRIES"],
