...
const SERVICES = [
  ...
  ["WHATSAPP MFA TEST", "ADMIN-ONLY INACTIVE-ACCOUNT PILOT / SIX-DIGIT KEYED-HASH OTP / 5-MINUTE EXPIRY / SINGLE USE / 5 ATTEMPTS / 60-SECOND, 10-HOURLY AND 20-DAILY SEND LIMITS / NOT LOGIN ENFORCEMENT", "WHATSAPP CLOUD API / SUPABASE", "/SPC/MFA-TEST"],
