...
const SERVICES = [
  ...
  ["WHATSAPP GROUP REDELIVERY", "SEPARATE WINDOWS-ONLY CHROME EXTENSION / ONE ACTIVE DEVICE / ONE IN-FLIGHT JOB / WHITESPACE-NORMALIZED EXACT GROUP MATCH / LEASED IDEMPOTENT QUEUE / DURABLE PRE-SEND RESERVATION / OFFLINE RETENTION / ATOMIC REOFFER + GROUP QUEUE / NATIVE WHATSAPP SUBMISSION / MINIMIZABLE LIVE STATUS / 24-HOUR CONFIRMED SEND JOURNAL / ALL-TRADER FAILURE ALERTS / MANUAL REVIEW ON UNCERTAIN SEND OR EXHAUSTED RETRIES", "DEDICATED WHATSAPP BUSINESS WEB / SPC APP / SUPABASE", "TOOLS/WHATSAPP-SPC-GROUP-DISPATCHER"],
