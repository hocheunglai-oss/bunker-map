...
const SERVICES = [
  ...
  ["MOBILE ENQUIRY MODE", "PERSONAL MANUAL ON/OFF / ONE RECEIVE PER 24-HOUR WHATSAPP SERVICE WINDOW / DIRECT TWO-PART ENQUIRY + BUYER DELIVERY WHILE OPEN / QUEUED RELEASE AFTER RENEWAL / IDEMPOTENT LEDGER / WEBHOOK STATUS / AUTOMATIC RETRIES / AUDITED ACTIVATION", "SPC APP / WHATSAPP CLOUD API / SUPABASE / VERCEL CRON", "/API/SPC/MOBILE-MODE / /API/WHATSAPP/WEBHOOK"],
