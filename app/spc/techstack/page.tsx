...
const SERVICES = [
  ...
  ["WHATSAPP LOGIN MFA", "FEATURE-FLAGGED REAL-LOGIN PILOT FOR OTTO ONLY / REGISTERED FRATELLI COSULICH HK SENDER / APPROVED SPC_LOGIN_MFA_CODE AUTHENTICATION TEMPLATE / PASSWORD THEN SIX-DIGIT WHATSAPP CODE / KEYED-HASH OTP / 5-MINUTE EXPIRY / SINGLE USE / 5 ATTEMPTS / 60-SECOND NEW-CODE LIMIT / ALL OTHER SPC ACCOUNTS REMAIN PASSWORD-ONLY", "SPC APP / WHATSAPP CLOUD API / SUPABASE", "/API/SPC/LOGIN/MFA"],
