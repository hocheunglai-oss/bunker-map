...
const SERVICES = [
  ...
  ["MOBILE ENQUIRY MODE", "PERSONAL MANUAL ON/OFF / APPROVED WHATSAPP TEMPLATE / RECEIVE ACKNOWLEDGEMENT / TWO SEPARATE ENQUIRY + BUYER MESSAGES / IDEMPOTENT DELIVERY LEDGER / WEBHOOK STATUS / AUTOMATIC RETRIES / AUDITED ACTIVATION", "SPC APP / WHATSAPP CLOUD API / SUPABASE / VERCEL CRON", "/API/SPC/MOBILE-MODE / /API/WHATSAPP/WEBHOOK"],
