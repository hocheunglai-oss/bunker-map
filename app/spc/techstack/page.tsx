...
const SERVICES = [
  ...
  ["MOBILE ENQUIRY MODE", "PERSONAL MANUAL ON/OFF / ONE RECEIVE PER 24-HOUR WHATSAPP SERVICE WINDOW / DIRECT TWO-PART ENQUIRY + BUYER DELIVERY WHILE OPEN / ATOMIC SINGLE-WORKER CLAIM / PER-MESSAGE CHECKPOINT / FAIL-CLOSED MANUAL REVIEW FOR UNCERTAIN SENDS / WEBHOOK STATUS / AUDITED ACTIVATION", "SPC APP / WHATSAPP CLOUD API / SUPABASE / VERCEL CRON", "/API/SPC/MOBILE-MODE / /API/WHATSAPP/WEBHOOK"],
  ...
  ["WHATSAPP GROUP DISPATCHER", "SEPARATE WINDOWS-ONLY CHROME EXTENSION / ONE ACTIVE DEVICE / EXACT GROUP MATCH / LEASED IDEMPOTENT QUEUE / OFFLINE RETENTION / OUTGOING-BUBBLE VERIFICATION / MANUAL REVIEW ON UNCERTAIN SEND", "DEDICATED WHATSAPP BUSINESS WEB / SPC APP / SUPABASE", "TOOLS/WHATSAPP-SPC-GROUP-DISPATCHER"],
