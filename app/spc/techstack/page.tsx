...
const SERVICES = [
  ...
  ["AUTHENTICATION", "OPAQUE 400-DAY SLIDING SERVER SESSIONS / DAILY ACTIVITY RENEWAL / SHA-256 TOKEN HASH / LOGOUT + REVOCATION + ACCOUNT-CHANGE INVALIDATION", "SPC APP / SUPABASE", "SPC USERS"],
