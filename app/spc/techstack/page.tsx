...
const SERVICES = [
  ...
  ["MOBILE ENQUIRY MODE", "PERSONAL 12-HOUR OPT-IN / APPROVED WHATSAPP TEMPLATE / RECEIVE ACKNOWLEDGEMENT / TWO SEPARATE ENQUIRY + BUYER MESSAGES / IDEMPOTENT DELIVERY LEDGER / WEBHOOK STATUS / AUTOMATIC RETRIES / AUDITED ACTIVATION", "SPC APP / WHATSAPP CLOUD API / SUPABASE / VERCEL CRON", "/API/SPC/MOBILE-MODE / /API/WHATSAPP/WEBHOOK"],
  ...
  ["ENQUIRY OUTCOME TRACKING", "USER-SCOPED SENT ENQUIRIES ACROSS COMPUTERS / OWNER-ONLY OUTCOME + REOFFER / SHARED SUPPLIER-TRADER SPEED BOARD FEED / FIXTURES / LOST RECORD", "SPC APP", "SPC_ENQUIRIES / SPC_FIXTURES"],
...
const DATABASE_GROUPS = [
  ...
  { title: "SPC OPERATIONS", tables: ["spc_enquiries", "spc_fixtures", "spc_mobile_modes", "spc_mobile_enquiry_deliveries"] },
