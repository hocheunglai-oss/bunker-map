...
- Shows a large WhatsApp send button on each enquiry. The button opens the sender's individual chat using an exact SPC username-to-phonebook email match; ambiguous phonebook matches are never guessed.
