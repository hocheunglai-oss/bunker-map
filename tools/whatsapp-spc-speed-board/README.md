...
- Shows a large WhatsApp arrow on each enquiry. The arrow opens the sender's individual chat using an exact SPC username-to-phonebook email match; ambiguous phonebook matches are never guessed.
