...
- The extension uses Chrome's debugger permission only to dispatch the WhatsApp send-button click from the background worker when DOM clicks are ignored.
