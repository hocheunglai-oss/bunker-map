...
function buildFolderLabel(filePath) {
  ...
  return relative.replace(/\.sbd/g, "").split(path.sep).slice(0, -1).join(" / ")
}
              ...
              <OfficeTab id="TabDefault">
                <Group id="SharedTemplatesGroup">
                  ...
                  <Control xsi:type="Button" id="OpenTemplatesPaneButton">
                    ...
                    <Supertip><Title resid="OpenPaneLabel"/><Description resid="OpenPaneDescription"/></Supertip>
                    <Icon>
...
await fs.writeFile(MANIFEST_PATH, buildManifest(BASE_URL), "utf8")
