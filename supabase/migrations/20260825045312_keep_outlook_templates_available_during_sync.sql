-- Keep Outlook Templates available while normal hourly Exchange work is
-- pending or processing. Insertions continue to use the last valid certified
-- projection, and still fail closed for failed work, corrupt evidence, stale
-- certification, changed templates, or mismatched recipient truth.
