...
5. **Measure actual cost and recovery access.** Inventory live, noncurrent,
   and soft-deleted bytes, abandoned live names after renames, manifests,
   requests, and execution costs. Current-source size is not total billed
   storage. The HKD77.50 budget update has been read back; the native Cloud Run
